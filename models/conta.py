...
class Conta:
    ...
    def depositar(self: object, valor: float) -> None:
        if valor > 0:
            ...
            print('Erro ao efetuar depósito, tente novamente e verifique o seu saldo.')
    ...
    def sacar(self: object, valor: float) -> None:
        if valor > 0 and self.saldo_total >= valor:
            ...
            print('Saque não realizado, o valor informado pode não estar disponível.')
            print('Por favor, consulte o seu saldo. Se necessário, ligue para central de atendimento')
